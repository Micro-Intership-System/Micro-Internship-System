...
exports.jobApplicationReceivedEmail = jobApplicationReceivedEmail;
exports.applicationAcceptedEmail = applicationAcceptedEmail;
exports.paymentReleasedEmail = paymentReleasedEmail;
exports.adminLoginEmail = adminLoginEmail;
...
function passwordResetEmail(name, resetToken) {
    const resetUrl = `${(0, email_1.getFrontendUrl)()}/reset-password?token=${resetToken}`;
    return {
 ...
 */
function emailVerificationEmail(name, verificationToken) {
    const verifyUrl = `${(0, email_1.getFrontendUrl)()}/verify-email?token=${verificationToken}`;
    return {
 ...
 */
function jobApplicationReceivedEmail(employerName, studentName, jobTitle, applicationId) {
    const viewUrl = `${(0, email_1.getFrontendUrl)()}/dashboard/employer/applications/${applicationId}`;
    return {
 ...
 */
function applicationAcceptedEmail(studentName, jobTitle, companyName, jobId) {
    const viewUrl = `${(0, email_1.getFrontendUrl)()}/internships/${jobId}`;
    return {
 ...
 */
function paymentReleasedEmail(studentName, amount, jobTitle, companyName) {
    return {
 ...
 */
function adminLoginEmail(name, loginTime, ipAddress) {
